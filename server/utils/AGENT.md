...
- O plugin Admin do Better Auth fornece roles, banimento e impersonation. Impersonation depende da coluna `session.impersonated_by` e cria cookie `admin_session` para permitir retorno à sessão original.
